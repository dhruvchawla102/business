...
function HomeBsn() {
  return (
    <div>
      ...
      <h2 className='info'>This Feature is in Progress</h2>
      <hr></hr>
      ...
      <div className="home__Section">
        <Card
          src="https://images.unsplash.com/photo-1565514417878-a66a6b0f2c7f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&h=150"
          title="Khata Book"
